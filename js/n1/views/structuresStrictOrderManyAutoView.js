...
(function () {
  ...
  N1.Views.StructuresStrictOrderManyAutoView = Backbone.View.extend({
    el: '#n1-app',
    template: _.template($('#structure-strict-many-auto-tmpl').html()),
    initialize: function () {
      var dataMany = Number.parseInt(this.$('#matrix-size-many-auto').val())
