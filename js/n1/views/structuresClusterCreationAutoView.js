...
(function () {
  ...
  N1.Views.StructuresClusterCreationAutoView = Backbone.View.extend({
    el: '#n1-app',
    template: _.template($('#structure-cluster-auto-tmpl').html()),
    initialize: function () {
      var dataCluster = Number.parseInt(this.$('#matrix-size-cluster-auto').val())
